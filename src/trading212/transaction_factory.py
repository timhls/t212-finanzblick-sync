...
class TransactionFactory:
    ...
    def from_order(order: Dict) -> Transaction:
        ...
        transaction_type = (
            TransactionType.BUY if direction == "BUY" else TransactionType.SELL
        )
    ...
    def from_transaction(transaction: Dict) -> Transaction:
        ...
        type_mapping: Dict[str, tuple[TransactionType, str]] = {
        ...
        transaction_type, description = type_mapping.get(
            type_str or "", (TransactionType.OTHER, "Transaktion")
        )
    ...
    @staticmethod
    def _parse_date(iso_date_str: Optional[str]) -> datetime:
        """
    ...
    def create_all_transactions(
        cls, orders: List[Dict], dividends: List[Dict], transactions: List[Dict]
    ) -> List[Transaction]:
        """
